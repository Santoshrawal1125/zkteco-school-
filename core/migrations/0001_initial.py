# Generated by Django 5.0 on 2025-05-20 07:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('school_admin', 'School Admin'), ('staff', 'Staff'), ('student', 'Student')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('attendee_type', models.CharField(choices=[('staff', 'Staff'), ('student', 'Student')], max_length=10)),
        ...
        migrations.AddField(
            model_name='student',
            name='student_class',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.studentclass'),
        ),
    ]
